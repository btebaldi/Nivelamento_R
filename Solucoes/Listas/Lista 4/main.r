...
# Questao 1 - Download do arquivo da Internet -----------------------------
source("./scripts/Listas/Lista 4/Download_file.r")

# Questao 2 - Data Loader -------------------------------------------------
source("./scripts/Listas/Lista 4/DataLoader.r")

# Questao 3 - Funcoes -----------------------------------------------------
source("./scripts/Listas/Lista 4/SemanaCount.R")
...
ggsave(filename = "Lista 4 - grafico 1 - covid19.png",
       path = "Graficos",
       plot = g1,
       scale=1, units = "in", dpi = 300, width = 10.4, height = 5.85)

ggsave(filename = "Lista 4 - grafico 2 - covid19.png",
       path = "Graficos",
       plot = g2,
       scale=1, units = "in", dpi = 300, width = 10.4, height = 5.85)
